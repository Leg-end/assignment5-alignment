            ...
            if do_backward:
                ...
                if step % eval_interval == 0:
                    ...
                    if eval_loss < best_eval_loss:
                        logging.info(f"Best eval loss updated at step {step}:  {best_eval_loss:.4f} -> {eval_loss:.4f}")
...
def main(model_name_or_path: str,
    ...
    output_dir = os.path.join(output_dir, model_name, f"checkpoint-{num_examples}")
